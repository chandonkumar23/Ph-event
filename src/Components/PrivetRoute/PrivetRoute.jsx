...
const PrivateRoute = ({ children }) => {
  ...
  if (showAlert) {
    return (
      <div className="fixed inset-0 bg-gradient-to-br from-purple-700 via-indigo-700 to-blue-500 flex items-center justify-center z-50">
        <div className="from-purple-700 via-indigo-700 to-blue-500 p-8 rounded-md shadow-lg max-w-md text-center">
          ...
          <p className="text-white">Redirecting to signup in {countdown} second{countdown !== 1 ? "s" : ""}...</p>
        </div>
      </div>
    );
  }
